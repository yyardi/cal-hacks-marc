...
def _parse_args() -> argparse.Namespace:
    ...
    default_page_width_m = float(SAFE_WORKSPACE_SIZE_M[0])
    default_page_height_m = float(SAFE_WORKSPACE_SIZE_M[1])
    parser.add_argument(
        "--page-width",
        type=float,
        default=default_page_width_m,
        help=(
            "Drawing page width in meters (default: "
            f"{default_page_width_m:.3f})"
        ),
    )
    parser.add_argument(
        "--page-height",
        type=float,
        default=default_page_height_m,
        help=(
            "Drawing page height in meters (default: "
            f"{default_page_height_m:.3f})"
        ),
    )
    parser.add_argument(
        "--travel-speed",
