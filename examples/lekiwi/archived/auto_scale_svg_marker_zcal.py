...
"""
SVG Auto-Scaler for Robot Workspace (MANUAL MARKER VERSION with Z-CALIBRATION)

This version includes safe manual marker insertion with gripper control,
interactive z-height calibration, and graceful handling of unreachable points.
"""
    ...
    while True:
        ...
        if command != 'q':
            ...
            if not success:
                ...
                current_z -= z_increment if command in ['w', 's'] else z_increment * 5
                continue
...
def safe_marker_pickup(robot, controller):
    ...
    try:
        ...
        close_position = -20.0  # Adjust this value - negative = closed
